...
<div style="margin-right: 20px; margin-left: 35px; margin-top: 25px; margin-bottom: 25px; ">
    <span style="margin-right: 10px; font-size: 23px; font-weight: 600; color:#666633">List</span>
    <div class="dropdown" style="display: inline-block; ">
        <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style=" margin-top: -10px; background-color: #666633; border-color: #666633;">
            Select
        </button>
...
<div class="modal fade" id="addStudentModal" tabindex="-1" role="dialog" aria-labelledby="addStudentModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #666633;">
                <h5 class="modal-title" id="addStudentModalLabel" style="color: #fff;">Add Student</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" style="color: #fff;">&times;</span>
                </button>
            </div>
            <div class="modal-body" style="background-color: #ddddbb;">
                <form action="{{ route('students.store') }}" method="post">
                    ...
                    <button type="submit" class="btn btn-primary" style="background-color: #666633; border-color: #666633;">Add Student</button>
                </form>
            </div>
        </div>
    </div>
...
<table class="table table-striped table-dark" style="border-radius: 10px; overflow: hidden; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.2);">
    ...
    <tbody style="background-color: #b2b266; ">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="background-color: #ddddbb;">
                        <form action="{{ route('students.update', $student->id) }}" method="post">
                            ...
                            <button type="submit" class="btn btn-primary" style="background-color: #666633; border-color: #666633;">Update Student</button>
                        </form>
                    </div>
                </div>
            </div>
